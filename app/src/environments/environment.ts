export const environment = {
  ...
  properties: {
    ...
    azureAuthURL:
      "https://login.microsoftonline.com/8d88c9c2-2058-486d-9cd4-2fc9010326bc/oauth2/v2.0/authorize",
    ...
    redirectUrlWebLogin:
      "https://carefirst-appprod.azurewebsites.net/logincomplete",
    postLogoutRedirectUri:
      "https://carefirst-appprod.azurewebsites.net/landingpage",
  },
};
